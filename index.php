...
?>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-md-block">
                            <h3>Make your life amazing with a Haircut</h3>
                            <p>
    ...
    <section class="contact-section" id="contact-us" style="background-color: #f3f3f3; padding: 50px 0;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 sm-padding">
                <div class="contact-info">
                    ...
                    <p style="color: #555;">
                        Welcome to our barbershop! We offer premium grooming services tailored for men who value style and sophistication.
                    </p>
                    <h3 style="color: #333;">
                         Rabat, Morocco
                        <br>
                    ...
                    <h4 style="color: #333;">
                        <span style="font-weight: bold">Email:</span> elfellakiilyass@gmail.com
                        <br>
                        <span style="font-weight: bold">Phone:</span> 0637897956
                    </h4>
                </div>
            </div>
            <div class="col-lg-6 sm-padding">
                <div class="contact-form">
                    <div id="contact_ajax_form" class="contactForm">
                        <div class="form-group colum-row row">
                            <div class="col-sm-6">
                                <input type="text" id="contact_name" name="name" class="form-control" placeholder="Name" style="border-color: #ccc;">
                            </div>
                            <div class="col-sm-6">
                                <input type="email" id="contact_email" name="email" class="form-control" placeholder="Email" style="border-color: #ccc;">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input type="text" id="contact_subject" name="subject" class="form-control" placeholder="Subject" style="border-color: #ccc;">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12">
                                <textarea id="contact_message" name="message" cols="30" rows="5" class="form-control message" placeholder="Message" style="border-color: #ccc;"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12">
                                <button id="contact_send" class="default_btn" style="background-color: #333; color: #fff;">Send Message</button>
                            </div>
                        </div>
...
<section class="widget_section" style="background-color: #222; color: #fff; padding: 50px 0;">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="footer_widget">
                    <img src="Design/images/barbershop_logo.png" alt="Brand" style="max-width: 100%;">
                    <p>
                        Our barbershop is created for men who appreciate premium quality, time, and a flawless look.
                    </p>
                    <ul class="widget_social">
                        <li><a href="#" data-toggle="tooltip" title="Facebook" style="color: #fff;"><i class="fab fa-facebook-f fa-2x"></i></a></li>
                        <li><a href="#" data-toggle="tooltip" title="Twitter" style="color: #fff;"><i class="fab fa-twitter fa-2x"></i></a></li>
                        <li><a href="#" data-toggle="tooltip" title="Instagram" style="color: #fff;"><i class="fab fa-instagram fa-2x"></i></a></li>
                        <li><a href="#" data-toggle="tooltip" title="LinkedIn" style="color: #fff;"><i class="fab fa-linkedin fa-2x"></i></a></li>
                        <li><a href="#" data-toggle="tooltip" title="Google+" style="color: #fff;"><i class="fab fa-google-plus-g fa-2x"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="footer_widget">
                    <h3 style="color: #fff;">Headquarters</h3>
                    <p>
                        Rabat, Morocco
                        <br>
                        Ycoub mansour
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer_widget">
                    <h3 style="color: #fff;">Subscribe to Our Updates</h3>
                    <div class="subscribe_form">
                        <form action="#" class="subscribe_form" novalidate="true">
                            <input type="email" name="EMAIL" id="subs-email" class="form_input" placeholder="Email Address..." style="border-color: #ccc;">
                            <button type="submit" class="submit" style="background-color: #333; color: #fff;">SUBSCRIBE</button>
